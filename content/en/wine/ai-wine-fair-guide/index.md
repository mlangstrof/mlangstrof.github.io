...
However anyone who has ever been to a big wine fair such as Expovina knows well that it's usually a busy affair and we certainly don't want to zigzag between the different corners of the fair area. So let's use one last prompt to generate a convenient route between booths that also considers our preferences. Personally I like to begin with sparkling, continue with dry whites, then reds and finally sweet wines, if the time allows and I'm in the mood. Within each category, I prefer to progress from lighter, more delicate wines toward the richer and more structured ones, as starting with a bruiser of a red can dull the subtleties of everything that follows. 
